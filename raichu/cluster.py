    ...
    def handle_transat(self):
        ...
        for index, module in enumerate(self.modules):
            if index<len(self.modules)-1:
                ...
                if module.subtype=="PKS_TRANS" and module.is_starter_module and next_module.subtype=="PKS_TRANS":
                    try:
                        module.recognition_domain.substrate.smiles=transator_clade_to_starter_substrate[next_module.synthesis_domain.subtype]
                    except:
                        module.recognition_domain.substrate="MALONYL_COA"
                elif module.subtype=="PKS_TRANS" and module.is_starter_module and not next_module.subtype=="PKS_TRANS":
                    module.recognition_domain.substrate="MALONYL_COA"
                elif module.subtype=="PKS_TRANS" and not module.is_starter_module and not module.is_termination_module and next_module.subtype=="PKS_TRANS":
                    module.recognition_domain.substrate="MALONYL_COA"
                    for domain in module.tailoring_domains:
                        domain.used=False
                    for new_domain in transator_clade_to_tailoring_reactions[next_module.synthesis_domain.subtype]:
                        if "KR" in new_domain:
                            subtype=new_domain.split("_")[-1]
                            if subtype=="KR":
                                subtype="A1"
                            module.tailoring_domains.append(make_domain(DomainRepresentation("dummy_gene", "DUMMY_KR", subtype, None, True, True),"MALONYL_COA",True))
                        else:
                            module.tailoring_domains.append(make_domain(DomainRepresentation("dummy_gene", new_domain, None, None, True, True),"MALONYL_COA",True))
                elif module.subtype=="PKS_TRANS" and not module.is_starter_module and not module.is_termination_module and not next_module.subtype=="PKS_TRANS":
                    module.recognition_domain.substrate="MALONYL_COA"
            else:
                if module.subtype=="PKS_TRANS":
                    module.recognition_domain.substrate="MALONYL_COA"
