...
if __name__ == "__main__":
    cluster_repr = ClusterRepresentation([ModuleRepresentation("PKS", "PKS_TRANS", "ACETYL_COA",
                                          ...
                                          ModuleRepresentation("PKS", "PKS_TRANS", "MALONYL_COA",
                                                               [DomainRepresentation("Gene 2", 'KS',
                                                                                     "ALPHABETA_OH", None, True,
                                                                                     True),
                                          ...
                                          ModuleRepresentation("PKS", "PKS_TRANS", "MALONYL_COA",
                                                               [DomainRepresentation("Gene 3", 'KS',
                                                                                     "SHDB", None, True,
                                                                                     True),
                                          ...
                                          ModuleRepresentation("PKS", "PKS_TRANS", "MALONYL_COA",
                                                               [DomainRepresentation("Gene 4", 'KS',
                                                                                     "NON_ELONGATING_DB", None, True,
                                                                                     True),
                                                                DomainRepresentation("Gene 4", 'ACP', None, None, True,
                                                                                     True)
                                                                ]),
                                          ...
                                          ModuleRepresentation("NRPS", None, "tyrosine",
                                                               [DomainRepresentation("Gene 5", 'C', None, None, True,
                                                                                     True),
                                                                DomainRepresentation("Gene 5", 'nMT', None, None, True,
                                                                                     True),
                                                                DomainRepresentation("Gene 5", 'A', None, None, True,
                                                                                     True),
                                                                DomainRepresentation("Gene 5", 'PCP', None, None, True,
                                                                                     True),
                                                                DomainRepresentation("Gene 5", 'E', None, None, True,
                                                                                     True),
                                                                DomainRepresentation("Gene 5", 'TE', None, None, True,
                                                                                     True)
                                                                ]),
                                          ])

    draw_cluster(cluster_repr,f'demo_cluster_trans_at_pks.svg')
