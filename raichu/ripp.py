    ...
    def initialize_modification_sites(self, modification_sites):
        ...
        for atoms_for_reaction in modification_sites:
            ...
            atoms_for_reaction_initialized = [self.chain_intermediate.atoms[atom[0]]
                                              for atom in atoms_for_reaction_with_numbers if
                                              atom[1] in atoms_in_structure]
        ...
        if self.tailoring_enzymes:
            for tailoring_enzyme_representation in self.tailoring_enzymes:
                ...
                tailoring_enzyme = TailoringEnzyme(
                    tailoring_enzyme_representation.gene_name, tailoring_enzyme_representation.type, modification_sites,
