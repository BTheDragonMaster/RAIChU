...
class Drawer:
    ...
    def process_structure(self):
        ...
        # for atom in self.structure.graph:
        #     if hasattr(atom, 'central_chain'):
        #         for bond in atom.bonds:
        #             for neighbour in bond.neighbours:
        #                 if neighbour != atom:
        #                     if hasattr(neighbour, 'central_chain'):
        #                         atom_1 = atom
        #                         atom_2 = neighbour
        #                         if atom_1.draw.positioned and atom_2.draw.positioned:
        #                             line = Line(atom_1.draw.position,
        #                                         atom_2.draw.position, atom_1,
        #                                         atom_2)
        #                             angle = line.get_angle()
        #                             print('angle and atoms', atom, neighbour, line.get_angle())
        #                             if angle != math.radians(60) or angle != math.radians(-60):
        #
        #                                 if angle < 0:
        #                                     new_angle = math.radians(-60)
        #                                 else:
        #                                     new_angle = math.radians(60)
        ...
        if is_polyketide:
            ...
            print(atoms_in_central_chain, 'CENTRAL CHAIN')
            for i in range(len(atoms_in_central_chain) - 1):
                ...
                print('angle and atoms', atom_1, atom_2, angle)
