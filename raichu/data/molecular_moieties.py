...
_STARTER_PKS_TO_BACKBONE = {
    "WILDCARD_STARTER": [1, 2],
    "PROPIONYL_COA": [1, 3, 4],
    "ACETYL_COA": [1, 2],
    "BENZOYL_COA": [1, 2, 3],
...
THIOESTER_CARBON_REDUCED_O = GroupDefiner(
    "thioester carbon reduced oxygen", "SC(C)O", 1
)
THIOESTER_CARBON_OXYGEN_INSERTED = GroupDefiner(
    "thioester carbon oxygen inserted", "SC(O)=O", 1
)
