    ...
    def initialize_tailoring_enzymes_on_structure(self):
        if self.tailoring_enzymes_representation:
            for tailoring_enzyme_representation in self.tailoring_enzymes_representation:
                atoms = [atom for atom in self.self.chain_intermediate.atoms.values() if str(atom) in tailoring_enzyme_representation.atoms]
                if len(atoms<tailoring_enzyme_representation.atoms):
