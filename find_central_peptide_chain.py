        ...
        if atom.type == 'S':
            ...
            while not terminal_nitrogen:
                ...
                if current_atom.type == 'C':
                    if len(current_atom_neighbour_types) == 3 and current_atom_neighbour_types.count('O') == 1 and current_atom_neighbour_types.count('N') == 1 and current_atom_neighbour_types.count('C') == 1:
                                ...
                                if x in visited:
                                    ...
                                    for b in current_atom_neighbours:
                                        if b.type == 'C':
                                            if b not in visited:
                                                current_atom = b
                    if len(current_atom_neighbour_types) == 4 and current_atom_neighbour_types.count('H') == 1 and current_atom_neighbour_types.count('N') == 1:
                    ...
                    if current_atom_neighbour_types.count('H') == 2 and current_atom_neighbour_types.count('C') == 1:
                        for z in current_atom_neighbours:
                            if z.type == 'C':
                                if z in visited:
                                    ...
                                    visited.append(current_atom)
                                    central_peptide_chain.append(current_atom)
                    if current_atom_neighbour_types.count('H') == 1 and current_atom_neighbour_types.count('C') == 2:
                        visited.append(current_atom)
                        central_peptide_chain.append(current_atom)
